...
tips-dataset-43 = Будучи ядерным оперативником, помните о скрытном варианте. Капитану будет сложнее отбиться, если его застанет врасплох тот, кого он считает обычным ассистентов
